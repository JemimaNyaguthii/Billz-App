...
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE paid=1 AND dueDate BETWEEN :startDate AND :endDate")
//    fun getPaidWeeklyBillsSum(startDate: String, endDate: String): Double
//
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE paid=0 AND dueDate BETWEEN :startDate AND :endDate AND dueDate > :today")
//    fun getUpcomingBillsThisWeek(startDate: String, endDate: String, today: String): Double
//
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE paid=0 AND dueDate BETWEEN :startDate AND :endDate AND dueDate < :today")
//    fun getOverdueBillsThisWeek(startDate: String, endDate: String, today: String): Double
//
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE dueDate BETWEEN :startDate AND :endDate")
//    fun getTotalWeeklyBills(startDate: String, endDate: String): Double

//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE paid=1 AND dueDate BETWEEN :startDate AND :endDate")
//    fun getPaidYearlyBillsSum(startDate: String, endDate: String): Double
//
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE paid=0 AND dueDate BETWEEN :startDate AND :endDate AND dueDate > :today")
//    fun getUpcomingBillsThisYear(startDate: String, endDate: String, today: String): Double
//
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE paid=0 AND dueDate BETWEEN :startDate AND :endDate AND dueDate < :today")
//    fun getOverdueBillsThisYear(startDate: String, endDate: String, today: String): Double
//
//    @Query("SELECT SUM(amount) FROM UpcomingBills WHERE dueDate BETWEEN :startDate AND :endDate")
//    fun getTotalYearlyBills(startDate: String, endDate: String): Double
}
