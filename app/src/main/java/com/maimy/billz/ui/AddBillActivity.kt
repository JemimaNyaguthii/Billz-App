...
import com.maimy.billz.databinding.ActivityAddBillBinding
...
class AddBillActivity : AppCompatActivity() {
    ...
    fun validateBill() {
        ...
        if (name.isBlank()) {
            error = true
            binding.etName.error = getString(com.maimy.billz.R.string.name_required)
        }
        if (amount.isBlank()) {
            error = true
            binding.etName.error =
                getString(com.maimy.billz.R.string.amount_is_required)
        }
